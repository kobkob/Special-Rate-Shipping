...
Installing "Special Rate Shipping" can be done either by searching for "Special Rate Shipping" via the "Plugins > Add New" screen in your WordPress dashboard, or by using the following steps:
